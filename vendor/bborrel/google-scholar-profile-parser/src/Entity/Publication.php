...
class Publication
{
    ...
    /** @var string Non-abbreviated list of authors, comma separated */
    private $authors_full;

    /** @var string Journal name, volume, issue, pages */
    private $publisherDetails;

    /** @var string Non-abbreviated journal name, volume, issue, pages */
    private $publisherDetails_full;
